...
export const translations: Record<Language, Record<UIStringKeys, string>> = {
  [Language.EN]: {
    ...
    [UIStringKeys.LabelCoreProblem]: "Core Problem Your Product/Service Solves",
    [UIStringKeys.PlaceholderCoreProblem]: "e.g., Reducing manual data entry for sales teams",
  ...
  [Language.ES]: {
    ...
    [UIStringKeys.LabelCoreProblem]: "Problema Central que Resuelve tu Producto/Servicio",
    [UIStringKeys.PlaceholderCoreProblem]: "Ej: Reducir la entrada manual de datos para equipos de ventas",
